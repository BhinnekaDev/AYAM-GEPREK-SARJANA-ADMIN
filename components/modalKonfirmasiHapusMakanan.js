...
const ModalKonfirmasiHapusMakanan = ({
  terbuka,
  tertutup,
  makananYangTerpilih,
  konfirmasiHapusMakanan,
  sedangMemuatHapus,
}) => {
  return (
    <Dialog
    ...
    >
      ...
      <DialogHeader className="text-black">
        Konfirmasi Hapus Data Makanan
      </DialogHeader>
      <DialogBody className="text-black">
        <p>
          Apakah Anda yakin ingin menghapus makanan{" "}
          <strong className="font-bold">{makananYangTerpilih}</strong>? Tindakan
      ...
      <DialogFooter className="space-x-4">
        <Button
          onClick={konfirmasiHapusMakanan}
          variant="gradient"
          color="red"
        ...
        >
          {sedangMemuatHapus ? <Memuat /> : "Hapus Makanan"}{" "}
        </Button>
      </DialogFooter>
    </Dialog>
  );
...
export default ModalKonfirmasiHapusMakanan;
