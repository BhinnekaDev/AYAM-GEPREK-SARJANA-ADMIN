          ...
          <div className="flex items-center text-center justify-between mx-2">
            ...
            <div className="flex gap-4">
              ...
              <Button className="flex p-2 items-center gap-4 tracking-wider bg-transparent text-black border border-gray-500 shadow-md hover:shadow-md">
                Unduh Dokumen
                <IoDocumentTextOutline className="text-xl bg-transparent" color="black" />
              </Button>
            </div>
          </div>
        </CardHeader>
            ...
            <tbody>
              <tr className="border-b border-blue-gray-50">
                ...
                <td className="flex justify-center">
                  <Button color="green" size="sm" className="text-blue-500 hover:text-blue-700 bg-transparent" onClick={() => tanganiLihat()}>
                    <FaEye className="w-4 h-4" />
                  </Button>
                  <Button color="green" size="sm" className="text-blue-500 hover:text-blue-700 bg-transparent" onClick={() => konfirmasiHapus()}>
